...
net_weights = '/media/bruce/research/trial_17/models/caffe_alexnet_train_iter_200000.caffemodel';

net_model_fc6 = '/media/bruce/research/trial_17/config/fc6.prototxt';
net_model_fc7 = '/media/bruce/research/trial_17/config/fc7.prototxt';
net_model_fc8 = '/media/bruce/research/trial_17/config/fc8.prototxt';
net_model_fc9 = '/media/bruce/research/trial_17/config/fc9.prototxt';
net_model_fc10 = '/media/bruce/research/trial_17/config/fc10.prototxt';
net_model_fc11 = '/media/bruce/research/trial_17/config/fc11.prototxt';
...
fid = fopen('/media/bruce/research/test_data/dataset_images/name');
tline = fgets(fid);
file_count = 0;
files = {};
while ischar(tline)
...
for i = 1:file_count
    ...
    im = imread(['/media/bruce/research/test_data/dataset_images/', folder, '/', name, '.jpg']);
...
save('feature_fc7.mat','result_matrx_fc7');
